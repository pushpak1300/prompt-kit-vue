...
>(
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          <SheetContent
            ...
            data-mobile="true"
            className="w-(--sidebar-width) bg-sidebar text-sidebar-foreground top-[60px] border-none p-0 shadow-none [&>button]:hidden"
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className="text-sidebar-foreground group peer absolute left-0 top-0 hidden md:block"
        data-state={state}
